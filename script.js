...
function calcTime(dates) {
	...
	function updateTimer(date){
		//getTime method returns the number of milliseconds since midnight Jan 1, 1970
		...
		// select element
		document.querySelector('.clock-week').innerHTML = weeks;
		...
		if(now >= date){
			clearInterval(startTimer);
			document.querySelector('.clock-week').innerHTML = ' ';
			document.querySelector('.clock-day').innerHTML = ' ';
